     ...
     <footer className="bg-[#1A2B24] text-[rgba(255,255,255,0.6)] py-10 text-center text-sm">
       <div className="max-w-[900px] mx-auto px-6">
         ...
         <div className="mb-3">
           ...
           <a href="/inquiry" class="mx-3 hover:text-[var(--accent)] transition-colors">Inquiry</a><a href="/guide" className="mx-3 hover:text-[var(--accent)] transition-colors">Photo Guide</a>
         </div>
