         ...
         <div className="grid grid-cols-1 md:grid-cols-[1fr_1.5fr] gap-[60px] items-center">
           ...
           <div>
             ...
             <p className="text-[16px] text-[var(--text-secondary)] mb-4">
               I&apos;m <strong>[Your Name]</strong>, a Feng Shui consultant who bridges classical Chinese Feng Shui with modern spatial psychology. I&apos;ve studied traditional Flying Stars, Bagua mapping, and Five Elements theory — but I translate them into language and actions that make sense for modern homes.
             </p>
             <p className="text-[16px] text-[var(--text-secondary)] mb-4">
